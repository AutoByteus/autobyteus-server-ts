...
describe("RunHistoryService", () => {
  ...
  beforeEach(async () => {
    ...
    vi.clearAllMocks();
    mockAgentManager.listActiveInstances.mockReturnValue([]);
    mockAgentManager.getAgentInstance.mockReturnValue(null);
  ...
  it("rebuilds index from disk and groups run history", async () => {
    ...
    mockAgentManager.listActiveInstances.mockReturnValue(["run-1"]);
