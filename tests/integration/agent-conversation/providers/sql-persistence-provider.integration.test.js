...
const cleanupConversation = async (provider, agentId) => {
...
describe("SqlPersistenceProvider", () => {
    it("creates conversations", async () => {
        ...
        const conversation = await provider.createConversation(agentId, agentDefinitionId, llmModel);
    ...
    it("creates conversations with XML tool format", async () => {
        ...
        const conversation = await provider.createConversation(agentId, agentDefinitionId, llmModel, true);
        expect(conversation).toBeInstanceOf(AgentConversation);
    ...
    it("stores messages", async () => {
        ...
        const conversation = await provider.createConversation(agentId, agentDefinitionId, "gpt-4", false);
