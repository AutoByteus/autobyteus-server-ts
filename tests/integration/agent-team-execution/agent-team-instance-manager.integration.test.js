...
describe("AgentTeamInstanceManager integration", () => {
    ...
    it("throws when member config is missing", async () => {
        ...
        await expect(manager.createTeamInstance("main1", [])).rejects.toThrow(AgentTeamCreationError);
    });
    it("detects circular dependencies between team definitions", async () => {
        ...
        await expect(manager.createTeamInstance("A", [])).rejects.toThrow(AgentTeamCreationError);
    });
    it("throws if coordinator is a team instead of an agent", async () => {
        ...
        await expect(manager.createTeamInstance("main1", memberConfigs)).rejects.toThrow(AgentTeamCreationError);
    });
    it("terminates team instances and propagates failures", async () => {
        ...
        await expect(manager.terminateTeamInstance("bad_id")).rejects.toThrow(AgentTeamTerminationError);
    });
