...
import { AgentTeamInstance } from "../types/agent-team-instance.js";
...
export class AgentTeamInstanceConverter {
  static toGraphql(domainTeam: TeamLike): AgentTeamInstance {
    try {
