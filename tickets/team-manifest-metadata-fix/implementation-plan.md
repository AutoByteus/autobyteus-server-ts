...
- Replace manifest metadata derivation in `AgentTeamInstanceResolver.buildTeamRunManifest`.
...
1. `src/api/graphql/types/agent-team-instance.ts`
...
2. `tests/unit/api/graphql/types/agent-team-instance-resolver.test.ts`
...
- Run focused unit test file:
  - `pnpm vitest tests/unit/api/graphql/types/agent-team-instance-resolver.test.ts`
