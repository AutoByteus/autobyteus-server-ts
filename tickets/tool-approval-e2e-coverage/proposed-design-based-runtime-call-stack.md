...
4. `AgentTeamInstanceManager.getTeamInstance(teamId)` gate validates team exists
5. `AgentTeamInstanceManager.getTeamEventStream(teamId)` provides async event stream
